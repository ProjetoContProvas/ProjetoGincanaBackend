...
public class CursoController {
	...
	@GetMapping("/{id}")
	public CursoModel findById(@PathVariable("id") Integer id) {
	...
	@PutMapping("/{id}")
	@ResponseStatus(HttpStatus.CREATED)
	public ResponseEntity<CursoModel> update(@PathVariable("id") Integer id, @RequestBody CursoModel cursoModel) {
